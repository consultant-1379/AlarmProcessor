...
public class RepeatedAlarmHandlerTest {
    ...
    public void testHandleAlarm() {
        ...
        alarmProcessingResponse1 = new AlarmProcessingResponse();
        when(normalAlarmHandler.handleAlarm(alarmRecord)).thenReturn(alarmProcessingResponse);
        repeatedAlarmHandler.handleAlarm(alarmRecord);
        verify(normalAlarmHandler, times(1)).handleAlarm(alarmRecord);
    }
